package moe.lz233.googleglass.baidumaps.ui.adapter
...
open class MapCardAdapter(val cards: MutableList<CardBuilder>, val actions: MutableList<(() -> Unit)?> = mutableListOf()) : CardScrollAdapter() {
